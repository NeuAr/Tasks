...
/**
 * Исключение, которое выбрасывается, когда происходит дублирование модели
 *
 * @package App\Exceptions\Classes
 */
class DuplicateModelException extends ModelException
{
    /**
     * ID модели
     *
    ...
    /**
     * Создаёт экземпляр класса {@see DuplicateModelException}
     *
        ...
        Exception $previous = null)
    {
        ...
        if (!is_null($modelId))
        {
            ...
            else
            {
                ...
                $message = 'Произошло дублирование модели с указанным ID ('.$modelId.')';
            }
        }
        ...
        if (empty($message))
        {
            ...
            $message = 'Произошло дублирование модели';
        }
